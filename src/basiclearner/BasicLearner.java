...
public class BasicLearner {
	...
	FINAL_MODEL_FILENAME = "results/learnedModel", INTERMEDIATE_HYPOTHESIS_FILENAME = "results/hypothesis"; // a number gets appended
	
	
	static {
		  // create results dir, and if it already exists make it empty
		  File results_dir=new File("results");
          results_dir.mkdirs();
          File[] contents = results_dir.listFiles();
          if (contents != null) {
